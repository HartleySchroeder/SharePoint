...
$SPAppservers = @("MBPAPP0578PA", "MBPAPP0578PB", "MBPAPP0580PA", "MBPAPP0580PB") # only SharePoint Servers
$ServersinFarm = @("MBPAPP0578PA", "MBPAPP0578PB", "MBPAPP0580PA", "MBPAPP0580PB") #  SharePoint Servers including database and load balancing server
$Allservers = @("MBPAPP0578PA", "MBPAPP0578PB", "MBPAPP0580PA", "MBPAPP0580PB") #  SharePoint Servers including database and load balancing server + Mobile App Server
...
<font color = blue><H4><B>Failed Timer Jobs</B></H4></font>$TimerJobBody" -Title "SharePoint Farm Status Report" -CssUri D:\Solvera\FarmMonitoring\style.CSS | Out-File "D:\Solvera\FarmMonitoring\FarmReport.html" -Encoding ascii
...
$To = "hartley.schroeder@solvera.ca","gordon.hauser@solvera.ca"
$From = "sharepoint@gov.mb.ca" 
$Report = Get-Content "D:\Solvera\FarmMonitoring\FarmReport.html"
$mailBody = Get-Content "D:\Solvera\FarmMonitoring\emailBody.html"

send-mailmessage -from $From -to $To -subject $Subject -BodyAsHtml "$mailBody"-Attachments "D:\Solvera\FarmMonitoring\FarmReport.html" -priority High -dno onSuccess, onFailure -smtpServer $SMTP
